...
const string1 = JSON.stringify(baseDeDados)
...
consultandoBaseDeDados.then((resposta) => {
    ...
    function renderizarDadosUsuario(dados) {
        ...
        let info = ` <img src= ${dados.resultado[0].imagem.media}" alt="" id="image">
        <p id="nome">Nome Completo: ${dados.resultado[0].nome.titulo} ${dados.resultado[0].nome.primeiro} ${dados.resultado[0].nome.utlimo}</p>
        <p id="email">E-mail: ${dados.resultado[0].email}</p>
        `;
